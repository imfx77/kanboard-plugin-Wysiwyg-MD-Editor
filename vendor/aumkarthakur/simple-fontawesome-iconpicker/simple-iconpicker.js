...
jQuery(document).ready(function(){
    jQuery('body').prepend('<div class="howl-iconpicker-outer"><div class="howl-iconpicker-middle"><div class="howl-iconpicker"><div class="howl-iconpicker-title">Font Awesome Icons Picker</div><input type="text" class="srchicons" placeholder="Search" /> <div class="iconsholder"></div><div class="howl-iconpicker-close">Close</div></div></div></div>'); // Appending Iconpicker box below input box
...
(function(jQuery) {
    ...
    jQuery.fn.faiconpicker = function(localDocument) {
