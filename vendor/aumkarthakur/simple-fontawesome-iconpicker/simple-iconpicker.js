...
jQuery(document).ready(function(){
    ...
    jQuery('.howl-iconpicker').draggable({ handle: '.howl-iconpicker-title'});
...
(function(jQuery) {
    ...
    jQuery.fn.faiconpicker = function(localDocument, selector) {
        ...
        jQuery(this).click(function() {
            ...
            jQuery('.howl-iconpicker .geticonval').click(function() {
                ...
                jQuery(input_element).val('<i class="fa fa-' + getIconId + '"></i>');
                jQuery(input_element).trigger('input');
            });
        });
    }
