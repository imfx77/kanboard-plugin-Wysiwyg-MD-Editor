const EmojiPicker = function(options) {
        ...
        return {
            ...
            el: () => {
                ...
                if (!el) {
                    ...
                    return Array.from(localDocument.querySelectorAll(el));
                } else {
                    return undefined;
                }
            },
    ...
    const functions = {
            ...
            const styles = `
                <style>
                    ...
                    .fg-picker-special-buttons a {
                        background-color: ${this.options.specialButtons ? this.options.specialButtons : '#ed5e2877'};
                    }
        ...
        render: (e, attr) => {
            if (functions.checkPickerExistShow(e)) {
                return;
            }
            ...
            if (localDocument.querySelector('.fg-emoji-container')) {
            ...
            const picker = `
                <div class="fg-emoji-container" style="left: ${position.left}px; top: ${position.top}px;">
                    ...
                    <div class="fg-emoji-picker-search">
                        ...
                        ${this.options.searchAutofocus ? 'autofocus' : 'tabindex="-1"'}
                        />
            ...
            localDocument.body.insertAdjacentHTML('beforeend', picker);

            functions.rePositioning(localDocument.querySelector('.fg-emoji-container'));
        ...
        showPicker: (e) => {
            e.preventDefault();
            this.lib('.fg-emoji-container').removeClass('fg-emoji-container-hidden');
            moseMove = false;
        },

        hidePicker: (e) => {
            e.preventDefault();
            this.lib('.fg-emoji-container').addClass('fg-emoji-container-hidden');
            moseMove = false;
        },
        ...
        checkPickerExist(e) {
            return (localDocument.querySelector('.fg-emoji-container') && !e.target.closest('.fg-emoji-container') && !moseMove);
        },

        checkPickerExistShow(e) {
            if (functions.checkPickerExist.call(this, e)) {
                functions.showPicker.call(this, e);
                return true;
            }
            return false;
        },

        checkPickerExistHide(e) {
            if (functions.checkPickerExist.call(this, e)) {
                functions.hidePicker.call(this, e);
                return true;
            }
            return false;
        },

        checkPickerExistClose(e) {
            if (functions.checkPickerExist.call(this, e)) {
        ...
        categoryNav: e => {
            ...
            const emojiBody     = localDocument.querySelector('.fg-emoji-list');
        ...
        search: e => {
            ...
            if (!emojiList) {
                emojiList = Array.from(localDocument.querySelectorAll('.fg-emoji-picker-category-wrapper li'));
            }
    ...
    const bindEvents = () => {
        this.lib(localDocument.body).on('click', functions.hidePicker, '#fg-emoji-picker-close-button');
        //this.lib(localDocument.body).on('click', functions.checkPickerExistHide);
        this.lib(localDocument.body).on('click', functions.render, this.trigger);
        this.lib(localDocument.body).on('click', functions.insert, '.fg-emoji-list a');
        this.lib(localDocument.body).on('click', functions.categoryNav, '.fg-emoji-nav a');
        this.lib(localDocument.body).on('input', functions.search, '.fg-emoji-picker-search input');
