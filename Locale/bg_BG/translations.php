...
* Щракването върху иконите на емотикони вмъква и заменя текущия избор на текст.',
    'WysiwygMDEditor_SETTINGS_EMOJIFONT_ENABLE' => 'Изрично използване на вътрешен емотикон шрифт',
    'WysiwygMDEditor_SETTINGS_EMOJIFONT_DESCR' => 'Плъгинът предоставя вграден емоджи шрифт (базиран на Mozilla Twemoji), ако е необходимо да се подменят съществуващите емоджи презентации.
* Използването му ще гарантира, че емоджитата ще изглеждат по един и същи начин във всички браузъри на всички платформи.
* Освен това нито едно емотикони няма да липсва или да се показва зле поради непълни или стари версии на предоставените от браузъра или системата шрифтове.
* ⚠ От друга страна, тъй като тази опция ще замени веригата за приоритет на шрифтовете по подразбиране, текстовете на KB страниците може да изглеждат по различен начин !
* ⚠ Когато е активиран, шрифтът ще се използва във всички нормални страници, изгледи за редактиране и изобразяване на EasyMDE, независимо от настройката за Emoji Picker !
* ⚠ Промяната на тази опция изисква изрично презареждане на страницата, за да влезе в сила!',
